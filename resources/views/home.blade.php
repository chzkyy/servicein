    ...
    $(document).ready(function(){
        ...
        function showPosition(position) {
                        ...
                        return {
                            results: $.map(data.results, function (item) {
                                return {
                                    ...
                                    geo: item.geometry.location.lat + ',' + item.geometry.location.lng
                                }
                            })
                        };
                    },
            ...
            $('.js-data-example-ajax').on('select2:select', function (e) {
                ...
                // console.log(data);
                $('#link').html('<a href="https://www.google.com/maps/dir/?api=1&origin='+position.coords.latitude + ',' + position.coords.longitude+'&destination='+data.geo+'&travelmode=driving" target="_blank">Buka Google Maps</a>');
            });
        }
