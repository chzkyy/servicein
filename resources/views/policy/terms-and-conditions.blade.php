<div class="modal fade" id="terms-and-conditions" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
        <div class="modal-content rounded-1 border-0 text-black">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">{{ __('Terms and Conditions') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="m-2">

                    <h2><strong>{{ __("Terms and Conditions") }}</strong></h2>

                    <p>{{ __("Welcome to Servicein!") }}</p>

                    <p>{{ __("These terms and conditions outline the rules and regulations for the use of Servicein's Website,
                        located at ") }} <a href="https://servicein.me/" class="fw-semibold text-decoration-none text-black">{{ __("https://servicein.me/") }}</a></p>

                    <p>{{ __("By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        Servicein if you do not agree to take all of the terms and conditions stated on this page.")}}</p>

                    <p>{{ __("The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    ...
                    <p>{{ __("The following organizations may link to our Website without prior written approval:") }}</p>

                    <ul>
                        <li>{{ __("Government agencies;") }}</li>
                        <li>{{ __("Search engines;") }}</li>
                        <li>{{ __("News organizations;") }}</li>
                        <li>{{ __("Online directory distributors may link to our Website in the same manner as they hyperlink to
                            the Websites of other listed businesses; and") }}</li>
                        <li>{{ __("System wide Accredited Businesses except soliciting non-profit organizations, charity shopping
                            malls, and charity fundraising groups which may not hyperlink to our Web site.") }}</li>
                    </ul>

                    <p>{{ __("These organizations may link to our home page, to publications or to other Website information so
                    ...
                    <p>{{ __("We may consider and approve other link requests from the following types of organizations:") }}</p>
                    ...
                    <p>{{ __("We will approve link requests from these organizations if we decide that: (a) the link would not make
                        ...
                        the absence of Servicein; and (d) the link is in the context of general resource information.") }}</p>

                    <p>{{ __("These organizations may link to our home page so long as the link: (a) is not in any way deceptive;
                    ...
                    <p>{{ __("If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                        website, you must inform us by sending an e-mail to Servicein. Please include your name, your
                    ...
                    <p>{{ __("Approved organizations may hyperlink to our Website as follows:") }}</p>

                    <ul>
                        <li>{{ __("By use of our corporate name; or") }}</li>
                        <li>{{ __("By use of the uniform resource locator being linked to; or") }}</li>
                        <li>{{ __("By use of any other description of our Website being linked to that makes sense within the
                            context and format of content on the linking party's site.") }}</li>
                    </ul>

                    <p>{{ __("No use of Servicein's logo or other artwork will be allowed for linking absent a trademark license
                        agreement.") }}</p>

                    <h3><strong>{{ __("iFrames") }}</strong></h3>

                    <p>{{ __("Without prior approval and written permission, you may not create frames around our Webpages that
                        alter in any way the visual presentation or appearance of our Website.") }}</p>

                    <h3><strong>{{ __("Content Liability") }}</strong></h3>

                    <p>{{ __("We shall not be hold responsible for any content that appears on your Website. You agree to protect
                    ...
                    <h3><strong>{{ __("Reservation of Rights") }}</strong></h3>

                    <p>{{ __("We reserve the right to request that you remove all links or any particular link to our Website. You
                    ...
                    <h3><strong>{{ __("Removal of links from our website") }}</strong></h3>

                    <p>{{ __("If you find any link on our Website that is offensive for any reason, you are free to contact and
                    ...
                    <p>{{ __("We do not ensure that the information on this website is correct, we do not warrant its completeness
                    ...
                    <h3><strong>{{ __("Disclaimer") }}</strong></h3>

                    <p>{{ __("To the maximum extent permitted by applicable law, we exclude all representations, warranties and
                    ...
                    <p>{{ __("The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer:
                    ...
                    <p>{{ __("As long as the website and the information and services on the website are provided free of charge,
                        we will not be liable for any loss or damage of any nature.") }}</p>
                </div>
            </div>
            <div class="modal-footer">
                {{--  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>  --}}
                <button type="button" class="btn btn-primary" id="tnc-accept">Accept</button>
            </div>
        </div>
    </div>
</div>
